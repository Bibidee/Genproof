...
/** Pick the right chain definition based on the configured RPC */
function pickChain() {
  const endpoint = rpc() || "";
...
/** Local account (private-key) — used for the simulator demo flow */
...
/** Inject an external wallet address (MetaMask / GenLayer Snap) */
