...
import { shortenAddress, formatChainTimestamp, pickChainDate } from "@/lib/utils/format";
              ...
              {users.map((u) => (
                ...
                >
                  ...
                  <div className="shrink-0 text-right">
                    ...
                    {u.last_updated && (
                      <p className="text-xs text-muted">{formatChainTimestamp(pickChainDate(u.last_updated_iso, u.last_updated))}</p>
                    )}
                  </div>
                </Link>
              ))}
